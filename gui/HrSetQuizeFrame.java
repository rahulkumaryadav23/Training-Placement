...
public class HrSetQuizeFrame extends javax.swing.JFrame {

    private int counter=0;
    private List<QuestionPojo> questionList=new ArrayList<>();
    private String jobId;
    
    public HrSetQuizeFrame() {
        initComponents();
...
public HrSetQuizeFrame(String jobId){
    this();
    this.jobId=jobId;
}
    private boolean validateInput(){
        if(txtquestion.getText().trim().isEmpty()||txtOption1.getText().trim().isEmpty()||txtOption2.getText().trim().isEmpty()||txtOption3.getText().trim().isEmpty()||txtOption4.getText().trim().isEmpty()||comCrrectOption.getSelectedIndex()==0 )
                return false;
                return true;
    ...
    private QuestionPojo setQuestion(){
        ...
        question.setCorrectOption(comCrrectOption.getSelectedIndex());
    ...
    private void getQuestionFromList(){
        ...
        comCrrectOption.setSelectedIndex(question.getCorrectOption());
    ...
    private void btnpreviousActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnpreviousActionPerformed
        ...
        if(counter==questionList.size()){
            if(validateInput()){
                int result=JOptionPane.showConfirmDialog(null, "You have a Unsave question. Do you want to you save it","Confrom ?",JOptionPane.YES_NO_OPTION);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HrSetQuizeFrame().setVisible(true);
            }
        });
    }
