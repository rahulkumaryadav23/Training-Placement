...
public class HrJobRemoveFrame extends javax.swing.JFrame {

   DefaultTableModel model;
    public HrJobRemoveFrame() {
        initComponents();
    ...
    private void loadData(){
        try{
            List <JobPojo> alljobsList=JobDAO.getAllactiveJobByCurrentHr(CurrentUser.getId());
    ...
    private void initComponents() {
        ...
        btnremove.setFont(new java.awt.Font("Tempus Sans ITC", 1, 16)); // NOI18N
        btnremove.setText("Hr Remove Job");
        ...
        jPanel1.add(btnremove, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 525, 200, 25));
    ...
    private void btnremoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnremoveActionPerformed
        ...
        String jobId=(String)tblAllJobs.getValueAt(0, row);
        int resp=JOptionPane.showConfirmDialog(null, "Are you sure you want to remove job"+jobId+"?","Delet?",JOptionPane.OK_CANCEL_OPTION,JOptionPane.INFORMATION_MESSAGE);
        if(resp==JOptionPane.OK_OPTION){
             try{
                boolean result=JobDAO.removeJobbyJobId(jobId);
                if(result){
                    model.removeRow(row);
                    JOptionPane.showMessageDialog(null, "Job Deleted","deletion Successfuly",JOptionPane.INFORMATION_MESSAGE);
                ...
                JOptionPane.showMessageDialog(null, "Job Not Deleted","deletion Unsuccessfuly",JOptionPane.INFORMATION_MESSAGE);
            }
             catch(SQLException ex){
            JOptionPane.showMessageDialog(null, "DB Error","Error in generatinh HrId",JOptionPane.ERROR_MESSAGE);
            ex.printStackTrace();
